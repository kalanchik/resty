...
class RequestParamsContent extends StatelessWidget {
  const RequestParamsContent({super.key});
  ...
  void _editHeader(
    ...
    context.read<RequestBloc>().add(EditParamRequestEvent(
          param: entry,
          index: index,
        ));
  }
  ...
  void _addHeader(BuildContext context, MapEntry<String, String> entry) {
    context.read<RequestBloc>().add(AddParamRequestEvent(param: entry));
  }
}
